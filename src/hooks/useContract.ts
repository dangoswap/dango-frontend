...
import { ChainId, WETH } from '@dangoswap/sdk'
...
export const useTokenVendor = (id) => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getTokenVendorContract(id, library.getSigner()), [id, library])
}
