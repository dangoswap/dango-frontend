...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@dangoswap/sdk'
                  ...
                  {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsETH ? (
                        ...
                        <StyledInternalLink
                          href={`/remove/${
                            currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'KUB' : currencyIdA
                          }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'KUB' : currencyIdB}`}
                        >
                          {t('Receive BNB')}
                        </StyledInternalLink>
                      ) : null}
