...
import { JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@dangoswap/sdk'
...
export function getBkcScanLink(
  data: string | number,
...
export function getBkcScanLinkForNft(collectionAddress: string, tokenId: string): string {
