describe('Add Liquidity', () => {
  ...
  it('loads the BNB and tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'KUB')
  ...
  it('loads the WBNB and tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'WKUB')
    cy.get('#add-liquidity-input-tokenb #pair').should('contain.text', 'CAKE')
  })
  ...
  it('does not crash if BNB is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'KUB')
    cy.get('#add-liquidity-input-tokenb #pair').should('not.contain.text', 'KUB')
  })
